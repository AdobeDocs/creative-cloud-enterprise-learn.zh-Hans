...
<tr>
 <td>
   <a href="GettingStartedwithCloudDocuments.pdf" target="_blank">
    ...
    <div>
   <a href="GettingStartedwithCloudDocuments.pdf" target="_blank"><strong>云文档入门(PDF)</strong></a>
    </div>
 ...
 <td>
   <a href="ShootEditPublishyourPhotoswithCreativeCloud.pdf" target="_blank">
      <img alt="使用Creative Cloud拍摄、编辑和Publish您的照片" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="ShootEditPublishyourPhotoswithCreativeCloud.pdf" target="_blank"><strong>使用Creative Cloud拍摄、编辑和Publish您的照片(PDF)</strong></a>
    </div>
  ...
  <td>
   <a href="SketchCompandFinalizeaBrochureLayoutwithCreativeCloud.pdf" target="_blank">
    ...
    <div>
   <a href="SketchCompandFinalizeaBrochureLayoutwithCreativeCloud.pdf" target="_blank"><strong>用Creative Cloud(PDF)草绘、构图并完成小册子版面</strong></a>
    </div>
    <em>使用Adobe Comp在您的移动设备上快速探索关于印刷、Web、移动或社交的版面创意</em>
    <br>
  </td>
</tr>
</table>
...
<tr>
  <td>
   ...
   <a href="UnlimitedAdobeFontsatyourFingertips.pdf" target="_blank"><strong>触手可及的无限Adobe Fonts(PDF)</strong></a>
    ...
    使用移动设备上的Adobe[!DNL Capture]在现实世界中<em>[!DNL Capture]种有趣的字体，然后使用Adobe Fonts和Creative Cloud库识别并激活和保存类似的字体</em>
    <br>
  </td>
   <td>
    <img alt="间隔物" src="../assets/Whitespacer.png" />
...
<tr>
   ...
   <a href="ResponsiveandAnimatedSVGwithXDIllustratorandCSS.pdf">
    ...
    <div>
   <a href="ResponsiveandAnimatedSVGwithXDIllustratorandCSS.pdf"><strong>带有XD、Illustrator和CSS(PDF)的响应式和动画SVG</strong></a>
    </div>
    <em>只需几行CSS，即可为SVG文件添加一些动画</em>
    <br>
  </td>
  <td>
    <img alt="间隔物" src="../assets/Whitespacer.png" />
...
<tr>
 ...
 <td>
   <a href="AnyonecanbecreativewithCreativeCloud.pdf" target="_blank">
    ...
    <div>
   <a href="AnyonecanbecreativewithCreativeCloud.pdf" target="_blank"><strong>任何人都可以创作Creative Cloud(PDF)</strong></a>
    </div>
    <em>跟着这个快速技巧一起操作，向您展示如何使用Camera Raw滤镜使任何照片达到最佳效果</em>
    <br>
  </td>
  <td>
   ...
   <a href="CreatingCinemagraphswithPhotoshop.pdf" target="_blank"><strong>使用Photoshop创建影院(PDF)</strong></a>
    ...
    <em>通过将Adobe[!DNL Stock]中的视频与Photoshop中的巧妙蒙版技术相结合，制作一张活泼的照片。 通过运动和策略循环点</em>让图像栩栩如生
    <br>
  </td>
  <td>
   <a href="CreateJaw-DroppingGraphicswithPhotoshopAfterEffects.pdf" target="_blank">
      <img alt="使用Photoshop + After Effects创建令人惊叹的图形" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="CreateJaw-DroppingGraphicswithPhotoshopAfterEffects.pdf" target="_blank"><strong>使用Photoshop + After Effects(PDF)创建令人瞠目结舌的图形</strong></a>
    </div>
    <em>在After Effects中使用通用的视频技术来快速移除照片中的背景色，以便为您的设计项目制作独特的照片合成图</em>
    <br>
  </td>
</tr>
<tr>
  <td>
   <a href="GettoknowPhotoshopontheiPad.pdf" target="_blank">
    ...
    <div>
   <a href="GettoknowPhotoshopontheiPad.pdf" target="_blank"><strong>了解iPad上的Photoshop(PDF)</strong></a>
    </div>
    <em>通过重新设计的触控界面，将Photoshop的强大功能触手可及</em>
    <br>
  </td>
  <td>
...
<tr>
  <td>
   <a href="CreateUniqueGraphicsbyCombiningAdobeStockImages.pdf" target="_blank">
      <img alt="通过组合Adobe[!DNL Stock]图像来创建独特的图形" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="CreateUniqueGraphicsbyCombiningAdobeStockImages.pdf" target="_blank"><strong>通过合并Adobe[!DNL Stock]图像来创建独特的图形(PDF)</strong></a>
    </div>
  ...
  <td>
   <a href="ShowcaseyourdatawithAdobeStockMotionGraphicTemplates.pdf" target="_blank">
      <img alt="使用Adobe[!DNL Stock]动态图形模板展示您的数据" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="ShowcaseyourdatawithAdobeStockMotionGraphicTemplates.pdf" target="_blank"><strong>使用Adobe[!DNL Stock]动态图形PDF（模板）展示您的数据</strong></a>
    </div>
    <em>使用来自Adobe[!DNL Stock]</em>的运动图形模板添加运动和设计，从而以更具影响力的方式表示您的数据
    <br>
  </td>
</tr>
<tr>
  <td>
   ...
   <a href="ShowOffYourDesignWorkintheRealWorld.pdf" target="_blank"><strong>在现实世界中展示您的设计作品(PDF)</strong></a>
    ...
    <em>了解如何使用Adobe[!DNL Stock]</em>中的真实模板来模拟您的设计作品
    <br>
  </td>
<td>
...
<tr>
  <td>
   <a href="CreatingRealistic3DMock-upswithAdobeStockandDimension.pdf" target="_blank">
      <img alt="使用Adobe[!DNL Stock]和创建逼真的3D模型 [!DNL Dimension]" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
...
<tr>
 ...
 <td>
   <a href="IntrotoAnimationwithAfterEffects.pdf" target="_blank">
    ...
    <div>
   <a href="IntrotoAnimationwithAfterEffects.pdf" target="_blank"><strong>使用After Effects的动画简介(PDF)</strong></a>
    </div>
    <em>通过在After Effects中将视频与图形和文本相结合来创建动画合成</em>
    <br>
  </td>
  <td>
  ...
  <td>
   <a href="ShootEditPublishyourVideoswithCreativeCloud.pdf" target="_blank">
    ...
    <div>
   <a href="ShootEditPublishyourVideoswithCreativeCloud.pdf" target="_blank"><strong>使用Creative Cloud拍摄、编辑和Publish您的照片(PDF)</strong></a>
    </div>
    <em>在Premiere中使用易用的编辑工具和动态图形模板，将视频和动态图形结合在一起，为社交媒体讲述引人入胜的故事[!DNL Rush]</em>
    <br>
  </td>
</tr>
</table>
...
<tr>
   ...
   <a href="AdobeXDAdvancedVoicePrototyping.pdf" target="_blank"><strong>Adobe XD：高级语音原型制作(PDF)</strong></a>
    ...
    <em>创建交互式原型，它可以响应用户的点击、触摸和音频输入</em>
    <br>
  </td>
   <td>
   ...
   <a href="CoeditingReal-TimeDesignCollaborationUsingAdobeXD.pdf" target="_blank"><strong>协同编辑：使用Adobe XD进行实时设计协作(PDF)</strong></a>
    ...
    <em>了解如何使用Adobe XD和Creative Cloud中内置的同类共享工具，通过交互式原型与同事、客户和开发人员进行协作</em>
    <br>
  </td>
  <td>
   <a href="DesignandPrototypeInteractiveProjectswithCreativeCloud.pdf" target="_blank">
    ...
    <div>
   <a href="DesignandPrototypeInteractiveProjectswithCreativeCloud.pdf" target="_blank"><strong>设计带有Creative Cloud的交互式项目并为其创建原型(PDF)</strong></a>
    </div>
    <em>通过将Adobe XD与Adobe[!DNL Stock]</em>上多种多样的独特资源相结合，只需几分钟即可创造出完全交互式的动画用户体验
    <br>
  </td>
  <td>
   <a href="LetsXDSeeHowtoDesignPrototypeandHandofftoTeams.pdf" target="_blank">
    ...
    <div>
   <a href="LetsXDSeeHowtoDesignPrototypeandHandofftoTeams.pdf" target="_blank"><strong>我们来XD — 了解如何设计团队(PDF)、创建原型和移交团队</strong></a>
    </div>
    <em>组件为您提供了前所未有的灵活性，可让您将速度和一致性应用于设计工作流</em>
    <br>
  </td>
 </tr>
</table>