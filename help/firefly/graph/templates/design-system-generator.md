---
title: 设计系统生成器
description: 了解如何根据网站屏幕截图生成设计系统
...
了解如何根据网站屏幕截图生成设计系统。 图形在单个批处理运行中生成一组匹配的图标、图案和布局组件。 [开放设计系统生成器](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:b40cd34c-66b2-586c-ab4a-5595490cded6)。
