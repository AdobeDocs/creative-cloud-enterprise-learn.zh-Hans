...
| 图形模板 | 描述 | 使用案例 |
|---|---|---|
| [**开始使用 — 生成图像**](/help/firefly/graph/templates/get-started-gen-image.md) | 一个带有一个提示节点的基本图在一个输出中形成一个生成节点。 | <ul><li>主页横幅</li><li>Placeholder test</li><li>示例图像</li></ul> |
...
| 图形模板 | 描述 | 使用案例 |
|---|---|---|
| [**入门 — 分段图像**](/help/firefly/graph/templates/get-started-segment-image.md) | 加载任意源图像并运行分割节点以将主体与其背景隔离。 | <ul><li>清理抠图</li><li>目录隔离</li><li>首字下沉</li></ul> |
| [**合成和混合图层**](/help/firefly/graph/templates/composite-blend-layers.md) | 将产品抠图和背景场景作为单独的图层输入进行栈叠。 | <ul><li>生活方式/社交组合</li><li>主页横幅</li><li>o品牌复合</li></ul> |
...
| 图形模板 | 描述 | 使用案例 |
|---|---|---|
| [**品牌形象可视化**](/help/firefly/graph/templates/branding-visualization.md) | 在产品场景中可视化徽标或品牌。 | <ul><li>子品牌视觉</li><li>组件面板测试</li><li>身份预览</li></ul> |
| [**品牌产品模型**](/help/firefly/graph/templates/brand-product-mockup.md) | 在不同的场景中显示您的产品。 | <ul><li>店内模型</li><li>产品模型</li><li>建筑模型</li></ul> |
| [**编辑摄影**](/help/firefly/graph/templates/editorial-photoshoot.md) | 加载模型参考并交换每个新外观的服装输入。 | <ul><li>Lookbook拍摄</li><li>时事系列</li><li>Colorway排列</li></ul> |
| [**摄影工作室**](/help/firefly/graph/templates/photography-studio.md) | 将产品渲染置于工作室背景上，并调整光照，直到结果看起来像真实的工作室捕捉。 | <ul><li>SKU摄影室照片</li><li>启动页面呈现</li><li>产品线图片</li></ul> |
| [**对表面应用贴花**](/help/firefly/graph/templates/decal-to-surfaces.md) | 将基本产品模型以及贴花或徽标资源作为单独的输入进行加载。 | <ul><li>品牌重塑预览</li><li> 实时预览</li><li>徽标投放测试</li></ul> |

## 批处理和一致性操作

| 图形模板 | 描述** | 使用案例 |
|---|---|---|
| [**设计系统生成器**](/help/firefly/graph/templates/design-system-generator.md) | 根据网站屏幕截图生成设计系统。 | <ul><li>图标图案集</li><li>颜色系统</li><li>视觉语言</li></ul> |
| [**生成大头照**](/help/firefly/graph/templates/headshots-generation.md) | 协调企业的大头照。 | <ul><li>目录大头照</li><li>团队页面头像</li><li>专业大头照</li></ul> |
